...
//
// APIs for hosting CoreCLR (raw, low-level API — no hostfxr).
//
// On Android (and other platforms without hostfxr) we bootstrap CoreCLR through
// coreclr_initialize + coreclr_create_delegate instead of the desktop hostfxr path.
// Source: dotnet/runtime — src/coreclr/hosts/inc/coreclrhost.h
//
...
//
// Parameters:
//  errorWriter             - callback that will be called for each line of error info
